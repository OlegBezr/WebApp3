...
#app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:olezhechkab@localhost/lab_5'
heroku = Heroku(app)
...
def index():
	...
	if 'username' in session:
		...
		return render_template('index.html', title='Home', posts = posts, session_username=session_user.username, users = users)
	else:
